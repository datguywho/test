...
// Add image overlay on the target
var targetImage = document.createElementNS("http://www.w3.org/2000/svg", "image");
targetImage.setAttributeNS('http://www.w3.org/1999/xlink', 'href', "https://i.postimg.cc/gjcZLRqK/Untitled-design-15.png");
targetImage.setAttribute("x", target.x - 40); // Adjust positioning if needed
targetImage.setAttribute("y", target.y - 70); // Adjust positioning if needed
targetImage.setAttribute("width", "100");
targetImage.setAttribute("height", "100");
svg.appendChild(targetImage);
